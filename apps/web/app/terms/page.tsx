					...
					<div className="space-y-6">
						<section>
							...
							<p className="text-gray-700 leading-relaxed">
								My Speak은 영어 스피킹 학습을 위한 개인 프로젝트입니다. 
								4단계 체계적 학습을 통해 외국어 스피킹 실력 향상을 목표로 합니다.
							</p>
						</section>

						<section>
							<h2 className="text-xl font-semibold text-gray-900 mb-3">이용 조건</h2>
						...
						<section>
							<h2 className="text-xl font-semibold text-gray-900 mb-3">개인정보 보호</h2>
							<p className="text-gray-700 leading-relaxed">
						...
						<section>
							<h2 className="text-xl font-semibold text-gray-900 mb-3">면책사항</h2>
							<p className="text-gray-700 leading-relaxed">
